...
AIM:
To build and validate Logistic Regression Models for predicting diabetes
presence using the UCI and Pima Indians Diabetes datasets.
"""
...
print(f"Accuracy: {accuracy_uci:.4f}, Precision: {precision_uci:.4f}, "
      f"Recall: {recall_uci:.4f}, F1 Score: {f1_uci:.4f}")
print("\nPima Indians Diabetes Dataset - Logistic Regression Results:")
print(f"Accuracy: {accuracy_pima:.4f}, Precision: {precision_pima:.4f}, "
      f"Recall: {recall_pima:.4f}, F1 Score: {f1_pima:.4f}")
